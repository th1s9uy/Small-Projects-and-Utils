...
public class GetModel
{
	...
	public void getModel(String packageSearchPath) throws Exception
	{
		...
		for(int i = 0; i < model.length; i++)
		{
			...
			String modelFile="/reportnet/ExtractedModels/"+i+"model.xml";
	...
	public static void main(String args[])
	{
		...
		String userID = "millerbarr";
		String password = "Tribou1*12";
		// search path of the package from which the model will be extracted
		String packageSearchPath = "/content/package[@name='Financials']";
