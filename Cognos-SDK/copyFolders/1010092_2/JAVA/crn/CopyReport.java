...
{ 
	...
	{ 
		...
		String reportNetEndPoint = "http://localhost/crn11mr2/cgi-bin/cognos.cgi";
		
		// the searchPath's of the my Folders for the users to copy from and to.
		String searchPathFrom = "CAMID(\"SDK:u:uid=admin,ou=people\")/folder[@name='My Folders']//report";
		String searchPathTo =   "CAMID(\"SDK:u:uid=jsample,ou=people\")/folder[@name='My Folders']";
