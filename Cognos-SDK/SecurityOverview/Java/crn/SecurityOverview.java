...
public class SecurityOverview
{
	...
	public static void main(String[] args)
	{
		...
		String reportNetEndPoint = "http://reprd2:9300/p2pd/servlet/dispatch";
		// must be a user with System administrator privledges.
		String userName = "millerbarr";
		String password = "Tribou1*01";
		String nameSpaceID = "ADS";
		String fileName = "userGroupsAndRoles.csv";
