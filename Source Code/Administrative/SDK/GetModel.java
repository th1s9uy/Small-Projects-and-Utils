...
public class GetModel
{
	...
	public static void main(String args[])
	{
		...
		String endPoint = "http://cogpbi2:9300/p2pd/servlet/dispatch";
		...
		System.out.println("\nGrabbing \'" + packageName + "\' package from content store. Have patience my young padawan.\n");
		...
		try
		{
			...
			System.out.println("\nFinished grabbing \'" + packageName + "\' package");
		}
		catch (Exception e)
		{
			System.out.println(e);
